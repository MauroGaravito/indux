...
export async function seedAll() {
    // Users
    const users = [
        { email: 'admin@indux.local', name: 'Admin', role: 'admin', password: 'admin123', position: 'Administrator', phone: '+1-555-0001', companyName: 'Indux HQ', avatarUrl: '' },
        { email: 'manager@indux.local', name: 'Manager', role: 'manager', password: 'manager123', position: 'Site Manager', phone: '+1-555-0002', companyName: 'Indux HQ', avatarUrl: '' },
        { email: 'worker@indux.local', name: 'Worker', role: 'worker', password: 'worker123', position: 'Electrician', phone: '+1-555-0003', companyName: 'Subcontractor LLC', avatarUrl: '' },
    ];
