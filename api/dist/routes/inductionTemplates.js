...
import { InductionTemplateCreateSchema, InductionTemplateUpdateSchema, } from '../utils/validators.js';
const router = Router();
...
router.get('/summaries', requireAuth, requireRole('admin', 'manager'), async (_req, res) => {
...
router.put('/:id', requireAuth, requireRole('admin'), async (req, res) => {
    ...
    const template = await InductionTemplate.findByIdAndUpdate(id, {
        ...update,
