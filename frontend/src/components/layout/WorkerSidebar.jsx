...
const drawerItems = [
  ...
  { label: 'Assigned Inductions', to: '/worker/inductions', icon: <AssignmentTurnedInIcon />, match: '/worker/inductions' },
  { label: 'Certificates', to: '/worker/certificates', icon: <WorkspacePremiumIcon />, match: '/worker/certificates' },
  { label: 'Settings', to: '/worker/settings', icon: <SettingsIcon />, match: '/worker/settings' }
]

export default function WorkerSidebar({ variant = 'permanent', open, onClose, drawerWidth = 240 }) {
