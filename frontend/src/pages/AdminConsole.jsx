...
import { Alert, Button, Paper, Stack, TextField, Typography, MenuItem, Divider } from '@mui/material'
    ...
    <Stack spacing={2}>
      ...
      <Paper sx={{ p:2 }}>
        ...
        <Stack direction="row" spacing={2}>
          ...
          <Button variant="contained" onClick={createProject} disabled={!name}>Create</Button>
        </Stack>
      </Paper>
      <Paper sx={{ p:2 }}>
        ...
        {selectedId && (
          <Stack spacing={3} sx={{ mt:2 }}>
            ...
            <Stack direction="row" spacing={2}>
              ...
              <Button variant="contained" onClick={sendForReview}>Send For Review</Button>
            </Stack>
          </Stack>
        )}
      </Paper>
