    ...
    <Stack spacing={3}>
      ...
      {step === 1 && project && (
        <Paper sx={{ p: 2 }}>
          ...
          <Stack direction="row" spacing={1} sx={{ mt: 2 }}>
            ...
            <Button
              variant="contained"
              onClick={() => (validatePersonal() ? nextStep() : null)}
      ...
      {step === 5 && (
        <Paper sx={{ p: 2 }}>
          ...
          <Dialog open={confirmOpen} onClose={() => (status !== 'submitting' ? setConfirmOpen(false) : null)} maxWidth="xs" fullWidth>
            <DialogTitle>Confirm Submission</DialogTitle>
            <DialogContent>
              <Typography variant="body2">Are you sure you want to submit your induction?</Typography>
            </DialogContent>
...
function SlidesStep({ project, onBack, onNext }) {
  ...
  return (
    <Paper sx={{ p: 2 }}>
      ...
      {pptKey ? (
        <Stack spacing={2} sx={{ mb: 1 }}>
          ...
          <Stack direction="row" spacing={2} alignItems="center">
            ...
            {viewedMap[slideIndex] && <Typography variant="body2" color="success.main">You can go next</Typography>}
          </Stack>
          <Stack direction="row" spacing={1}>
      ...
      <Stack direction="row" spacing={1}>
        <Button onClick={onBack}>Back</Button>
        <Button variant="contained" onClick={onNext} disabled={!pptKey ? false : !(slideIndex === totalSlides && viewedMap[slideIndex])}>
          Continue
        </Button>
      </Stack>
